    ...
    <div class="col-md-6">
        ...
        <form action="">
            ...
            <div class="form-group">
                ...
                <input type="text" name="" class="form-control"  id="nombreCliente" placeholder="Ingrese Nombre del Cliente" Required>
            </div>
            <div class="form-group">
                <label for="apeCliente"> Apellidos Cliente:</label>
                <input type="text" name="" class="form-control"  id="apeCliente" placeholder="Ingrese Apellidos del Cliente" Required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="" class="form-control"  id="adultos" placeholder="Ingrese Número de Adultos" min="0" Required>
            </div>
            <div class="form-group">
                <label for="niños"> N° Niños:</label>
                <input type="number" name="" class="form-control"  id="niños" placeholder="Ingrese Número de Niños" min="0" Required>
            </div>
            <div class="form-group">
